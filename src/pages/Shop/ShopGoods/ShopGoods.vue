<template>
  <div class="goods">
    <div class="menu-wrapper">
      <ul>
        <li class="menu-item" :class="{current: index===currentIndex}"
            v-for="(good, index) in goods" :key="index" @click="selectCurrent(index)">
    ...
    <div class="foods-wrapper" ref="foodsWarpperUl">
      <ul>
        <li class="food-list food-list-hook" style="pointer-events: auto;"
